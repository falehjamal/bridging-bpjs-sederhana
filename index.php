        ...
        $('form').submit(function(e){
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                        ...
                        var code = res.metaData.code;
                        var message = res.metaData.message;
                        ...
                        switch(code) {
                            ...
                            case 404:
                            case 405:
                                $('.isi').html(`<div class="alert alert-danger">${message}</div>`);
                                break;
                            default:
                                $('.isi').html(`<div class="alert alert-danger">Ada kesalahan sistem.</div>`);
                        }
                },
                complete:()=>{
                    $('#loading').hide();
